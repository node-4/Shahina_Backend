...
module.exports = (app) => {
        ...
        app.get("/api/v1/admin/getServiceOrdersByuserId/:userId", auth.getServiceOrdersByuserId);
        ...
        app.put("/api/v1/admin/Slot/slotUnBlocked", [authJwt.verifyToken], auth.slotUnBlocked);
        ...
        app.put("/api/v1/admin/editSuggestionInCart/:userId/:suggesstionId", [authJwt.verifyToken], auth.editSuggestionInCart);
        ...
        app.put("/api/v1/admin/editSuggestionfromOrder/:id/:suggesstionId", [authJwt.verifyToken], auth.editSuggestionfromOrder);
        app.put("/api/v1/admin/deleteSuggestionfromOrder/:id/:suggesstionId", [authJwt.verifyToken], auth.deleteSuggestionfromOrder);
        app.put("/api/v1/admin/noShowUpdate/:id", [authJwt.verifyToken], auth.noShowUpdate);
        ...
        app.get("/api/v1/admin/notification/all/AdminNotification", authJwt.verifyToken, auth.allAdminNotification);
